Main Menu
CL2005-Database Systems - Lab-BCS-4A
Themepark
Muhammad Usman
•
Feb 23 (Edited Feb 23)
Steps to run the script:
1) Create a database named your roll_no_name i.e (p218743_zain)
2) use p218743_zain
3) source file path/themepark.sql
